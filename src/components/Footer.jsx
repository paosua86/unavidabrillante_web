...
function Footer() {
    return (
        ...
        <footer class="overflow-x-hidden px-3 py-8 text-light-blue transition-colors duration-200 bg-black dark:bg-gray-800 text-2 dark:text-gray-200">
            <div class="flex flex-col">
                ...
                <div class="flex flex-col mt-4 md:mt-0 md:flex-row">
                    <nav class="flex flex-col items-center justify-center flex-1 border-gray-100 md:items-end md:border-r md:pr-5">
                        <a aria-current="page" href="#/ttlink" class="text-sans hover:text-gray-700 dark:hover:text-white">
                            <p>Home</p>
                        </a>
                        <a aria-current="page" href="mailto:hola@unavidabrillante.com?subject=informacion&body=Hola quiero hablar con alguien sobre .." class="hover:text-gray-700 dark:hover:text-white">
                        <p>Contacto</p>
                        </a>

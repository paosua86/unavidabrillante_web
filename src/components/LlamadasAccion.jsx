...
import mujerinvitacion from '../assets/mujerinvitacion.svg';
      ...
      <div class="py-24 flex flex-col md:flex-row w-full p-4 text-center items-center justify-center border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <div>
          <h2 data-aos="fade-down"
            ...
            data-aos-duration="1500" class="py-8 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-strong-pink dark:text-white mb-2">Descárgate nuestra aplicación ahora</h2>
          <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Eleva tu autoestima y comienza a vivir como habías anhelado</p>
          <p className=" text-base text-gray-500" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="lg:mt-8 items-center justify-center lg:justify-left space-x-4  flex flex-col lg:flex-row">
            <a href="https://play.google.com/store/apps/details?id=com.unavidabrillante.unavidabrillante" className="container mt-12 lg:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <a href="https://una-vida-brillante.web.app/#/main" target="_blank"
                rel="noopener noreferrer" className="container mt-12 lg:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
